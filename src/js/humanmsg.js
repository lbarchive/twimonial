/*
  ...
  modified by livibeter; 2009-11-29T04:56:38+799
*/
...
var humanMsg = {
	...
	displayMsg: function(msg, theme) {
		...
		// Inject message
		jQuery('#'+humanMsg.msgID+' p').html('<span class="' + theme + '">' + msg + '</span>')
	
		// Show message
		jQuery('#'+humanMsg.msgID+'').show().animate({ opacity: humanMsg.msgOpacity}, 200, function() {
			jQuery('#'+humanMsg.logID)
				.show().children('ul').prepend('<li class="' + theme + '">'+msg+'</li>')	// Prepend message to log
